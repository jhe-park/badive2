...
export const ContactToCompany: React.FC = ({}) => {
  return (
    <div className="relative flex h-full w-full items-center justify-center md:h-[300px]">
      <Image src={'/inquiries/inquiriesBottom.png'} alt="scuberdiving" fill className="z-10 object-cover" />
      <div className="z-20 flex h-2/3 w-[calc(1520/1920*100%)] flex-col items-center justify-center gap-x-6 gap-y-6 py-6 md:flex-row md:py-0">
        <div className="flex h-full w-full flex-col items-center justify-center gap-y-2 bg-white py-2 md:w-1/3 md:py-0">
          <div className="relative h-12 w-12 md:h-24 md:w-24">
            <Image src={'/inquiries/kakao.png'} alt="scuberdiving" fill className="z-10 object-cover" />
          </div>
        ...
        <div className="flex h-full w-full flex-col items-center justify-center gap-y-2 bg-white py-2 md:w-1/3 md:py-0">
          <div className="relative h-12 w-12 md:h-24 md:w-24">
            <Image src={'/inquiries/phone.png'} alt="scuberdiving" fill className="z-10 object-cover" />
          </div>
