        ...
        <div className="relative overflow-hidden h-full">
          ...
          >
            {images.map((image) => (
              ...
              >
                <div className="aspect-video rounded-lg overflow-hidden shadow-md h-full w-full">
                  {image.link ? (
                    <>
                    <a
                      href={image.link}
                  ...
                  <div className="resort-title text-center mt-2 bg-white bg-opacity-75 p-2 rounded">
                    {image.title}
                  </div>
                </div>
              </div>
