    ...
    <div className="w-full h-full md:max-w-[1280px] xl:aspect-[1280/696] md:aspect-[768/545] aspect-[375/290] flex flex-col justify-evenly items-start ">
      ...
      <SlideUp>
        <div className="w-full grid grid-cols-2 gap-2 px-2">
          {[
            { src: "curriculum1.png", title: "스쿠버다이빙",url:"/banner/program1.png" },
            { src: "curriculum2.png", title: "프리다이빙",url:"/banner/program2.png" },
            { src: "curriculum3.png", title: "머메이드",url:"/banner/program3.png" },
            { src: "curriculum3.png", title: "머메이드",url:"/banner/program4.png" },
          ].map((item, index) => (
