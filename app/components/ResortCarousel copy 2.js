  ...
  return (
    <div className="relative w-full h-full px-[3vw] flex justify-center items-center">
      ...
      <div className="relative group h-full w-[80%] md:w-full flex items-center">
        ...
        <button
          onClick={handlePrev}
          className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 p-2 bg-white rounded-full  hover:bg-gray-100 transition-colors z-10"
          ...
          <div className="relative overflow-hidden h-full">
            ...
            >
              {images.map((image) => (
                ...
                >
                  <div className="aspect-video rounded-lg overflow-hidden h-36 md:h-full w-full">
                    <a
                      href={image.link}
                      target="_blank"
                    ...
                    {/* <div className="text-sm md:text-[18px] resort-title text-center mt-2  p-2 rounded flex justify-center items-center text-black">
                      {image.title}
                    </div> */}
        ...
        <button
          onClick={handleNext}
          className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 p-2 bg-white rounded-full hover:bg-gray-100 transition-colors z-10"
