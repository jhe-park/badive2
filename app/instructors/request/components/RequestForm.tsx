...
const PrivacyContent = () => (
  <div>
    ...
    <p>
      ○ BADIVE 신청자는 개인정보의 수집·이용에 대한 동의를 거부할 권리가 있으나 동의하지 않을 경우 <strong>강사모집 신청 접수</strong>가 거부될 수 있습니다.
    </p>
    <br />
    <br />

    <p>
      본인은 BADIVE 강사모집 신청함에 있어 상기 내용에 대하여 충분히 인지 하였으며, 기관의 개인정보 수집 및 이용, 준수사항 및 동의서 일체에{' '}
