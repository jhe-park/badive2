          ...
          <>
            <Table aria-label="Example table with dynamic content" shadow="none">
              <TableHeader>
                ...
                <TableColumn key="ceo" className="w-1/6 text-center">
                  CEO
                </TableColumn>
              ...
              <TableBody loadingContent={<Spinner label="로딩중" className="text-xl" />}>
                {faq.map((item, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="whitespace-nowrap text-center">{item.ceo}</TableCell>
                    <TableCell className="whitespace-nowrap text-center">{item.date}</TableCell>
                    <TableCell className="whitespace-nowrap text-center">
                      <Button color="primary" onPress={() => router.push(`/admin/resort/${item.id}`)}>
                        수정
                      </Button>
                    </TableCell>
                  </TableRow>
