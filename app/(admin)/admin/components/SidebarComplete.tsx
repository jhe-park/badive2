  ...
  return (
    <>
      <div className="flex">
        <div className="flex h-screen">
          <div
            className={cn(
              ...
              isHidden && 'md:-ml-72 md:-translate-x-72',
              !isHidden && 'md:-ml-0 md:-translate-x-0',
            )}
          >
        ...
        {/* mx-auto w-[95%] */}
        <div className="mx-0 flex h-[100vh] w-full flex-col gap-y-4 md:mx-4 md:w-full">
          <header className="mt-4 hidden h-[10vh] w-full items-center gap-3 rounded-medium border-small border-divider p-4 md:flex">
