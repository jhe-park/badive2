  ...
  return (
    <div className="flex flex-col w-full h-full gap-y-6 ">
      <ToastContainer
        ...
        theme="light"
      />
      <div className="flex flex-col h-full md:flex-row gap-y-6 w-full justify-center items-center">
        <div className="flex flex-col h-full gap-y-6 w-full md:w-1/3 relative m-6 justify-center items-center">
          <Image
      ...
      <div className="flex flex-col justify-center items-center gap-y-6 mt-6 h-full">
