'use client'
import { Checkbox, Link, Button, ScrollShadow, Textarea } from "@heroui/react";
  ...
  return (
    <div className="flex flex-col gap-3 w-full">
      ...
      <div className="w-full h-[30vh] border-2 border-gray-300 rounded-lg p-6 overflow-y-auto scrollbar-hide">
        ...
        <p>본 이용약관은 "BDN DIVE"의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.</p>
        ...
        <p>우리 회사(BDN DIVE)는 신규 회원의 전화번호 수집 양식 및 기존 회원 대상의 공지 이메일 등을 통해 안내 주문, 배송 정보 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능 하거나 수신 차단하신 경우에는 일반 문자 메시지로 보내드립니다. 와이파이 아닌 이동통신망으로 접속 시 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 알림톡과는 다른 방식으로 정보 수신을 원하시면 알림톡을 차단해주세요.</p>
      ...
      <div className="w-full h-[20vh] border-2 border-gray-300 rounded-lg p-6 overflow-y-auto scrollbar-hide">
        ...
        <p>BDN DIVE는 아래의 목적으로 개인정보를 수집 및 이용하며, 회원의 개인정보를 안전하게 처리하는데 최선을 다하고 있습니다. 아래의 내용을 확인 후 동의하여 주시기 바랍니다.</p>

        <p><strong>1. 수집 및 이용 목적</strong><br />
          BDN DIVE의 개인 맞춤형 상품∙서비스 및 혜택 정보 제공, 이벤트 또는 광고성 정보 전달 및 참여 기회 제공, 상품∙서비스 이용 실적 정보 통계∙분석을 통한 신규 서비스 개발</p>
        ...
        <p>BDN DIVE가 제공하는 다양한 서비스 (<a href="#">자세히</a>) 가 포함되며, 특정 서비스 관련 정보를 제공받고 싶지 않으시면, 언제든지 My 알림 설정으로 동의 철회가 가능합니다.</p>
      ...
      <div className="flex justify-center items-center gap-5 w-full">
        <Button onPress={handleCancel} className="w-1/4" color="" variant='bordered' type="button">
          취소
        </Button>
