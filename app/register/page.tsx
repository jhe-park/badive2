  ...
  return (
    <div className="flex h-full  w-full flex-col items-center justify-center gap-y-10 my-32">
      <div className="flex flex-col items-center gap-y-5">
        ...
        <div>
          <p className="text-small text-default-500 text-[24px]">회원가입</p>
        </div>
      </div>
      <div className="mt-2 flex w-[500px] flex-col gap-4 rounded-large bg-content1 px-8 py-6 shadow-small">
