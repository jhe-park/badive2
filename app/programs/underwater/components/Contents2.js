...
export default function () {
  const data = {
    title: "언더워터 댄스",
    image: "/programnew/underwater2.png",
    subtitle: "어드밴스드 언더워터 댄스(D2)",
    description: "한계를 넘어선 춤사위, 어드밴스 언더워터",
    lines: [
      {
    ...
    instruction: [
      {
        ...
        description2: `
        <div>물과 인체에 대한 이해  · 메이크업  · 어드밴스드 언더워터 댄스 스킬 · 마인드 셋 · 안전</div>  
        `,
      },
      {
        title: "스튜디오",
      ...
      },
      {
        ...
        description2: `
        <div>물에 떠 있기 · 부력조절 ·어드밴스 언더워터 댄스 스킬 · 프리스타일 · 의상 및 소품 컨트롤 ·안전 및 레스큐  </div> 
        `,
      }
    ],
