    ...
    <div className="w-[80vw] h-full flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="text-3xl ">
          <p>
            <span className="font-bold">다이버 리더쉽 스킬</span>을 배우는 교육
            과정
          </p>
        </div>
        <div className="text-3xl flex flex-col items-center justify-evenly gap-y-5">
          <p>
            ...
            <span className="font-bold">
              ※ 만 18세 이상, 오픈워터, 어드밴스, 레시큐 다이버 자격 취득 및
              5가지 PADI 스페셜티 코스 자격증 및
            </span>
          </p>
          <p>
      ...
      <div className="w-full h-full my-12 flex flex-col items-center justify-evenly gap-y-5">
        ...
        <div className="flex  items-center justify-evenly gap-y-5 gap-x-12 w-4/5 h-full my-12">
          <div className="flex flex-col items-center justify-start gap-y-5 w-full bg-[#BBD1EA] rounded-lg p-5 h-[400px] overflow-hidden">
            ...
            <div className="text-3xl w-2/3">다이버 리더쉽 스킬 교육</div>
          </div>
          ...
          <div className="flex flex-col items-center justify-start gap-y-5 w-full bg-[#507DBC] rounded-lg p-5 h-[400px] overflow-hidden">
            ...
            <div className="text-3xl w-2/3">스페셜 티 코스 참가</div>
          </div>
        </div>
        <div className="w-4/5 h-full flex items-center justify-center gap-y-5 flex-col text-3xl bg-[#65AFFF] py-12">
          <div className="text-[#AE0000] font-bold bg-white w-[90%] py-2 text-center">
            마스터 다이빙 자격증 취득 후
          </div>
          <div className="text-white flex flex-col items-center justify-evenly gap-y-2">
            <p className="text-center">
              다이빙을 계획하고 조직하고 지시함으로 훈련 및 비훈련 관련 다이빙
              액티비티를 감독 가능
            </p>
            <p className="text-center">
              모든 다이버 코스들의 트레이닝 세션 동안 인스트럭터를 보조하며,
              독립적으로 오픈 워터 다이버 코스 학생들을
            </p>
            <p className="text-center">
      ...
      <div className="w-full h-full my-12 flex flex-col items-center justify-evenly gap-y-5">
        ...
        <div className="text-4xl flex font-bold flex-col justify-center items-center gap-x-2 bg-[#CCE6F4] rounded-lg p-5 w-4/5 h-full gap-y-5 overflow-hidden py-12">
          <div>-만 18세 이상 </div>
          <div>
            -오픈워터 다이버, 어드밴스 오픈워터 다이버 라이센스 소지자(or 타
            단체에서 동등 자격을 가지신 분들)
          </div>
          <div>
          ...
          <div>
            -레스큐 다이버 라이센스 소지자(or 타 단체에서 동증자격을 가지신
            분들)
          </div>
        ...
        <div className="w-full h-full flex flex-col items-center justify-evenly gap-y-14">
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-12 gap-y-5 mt-12 ">
            ...
            <div className="text-3xl text-[#8D0000] flex flex-col items-center justify-evenly">
              <p>
                · 워터스킬과 스테미너 엑서사이즈를 완성하게 될 뿐 아니라, 다른
                사람들이 그들의 스쿠버 능력을 개선하도록 도와주고
              </p>
              <p>
                문제를 해결하고 조작하는 능력을 키우게 해주는 트레이닝
                엑서사이즈를 실행하게 됩니다.
              </p>
            </div>
          </div>
          ...
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-12 gap-y-5">
            ...
            <div className="text-3xl gap-y-3 flex flex-col items-center justify-evenly">
              <div>
                <p className="text-center">
                  ■ 교육 오리엔테이션과 교육 및 안전, 보험과 관련된 서류를
                  작성합니다.
                </p>
              </div>
            </div>
          ...
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-12 gap-y-5">
            ...
            <div className="text-3xl">
              ...
              <p>
                ■ 스페셜티 코스는 담당강사와의 상담을 통하여 본인이 원하거나
                추천받은 스페셜 티 코스를 선택하여 참여 가능합니다.{" "}
              </p>
            </div>
          </div>
          ...
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-12 gap-y-5">
            ...
            <div className="text-3xl flex flex-col items-center justify-evenly w-[95%]">
              <p>
                프로젝트 어웨어 / 산호암초 보존 / 응급산소 제공자 / 장비
                스페셜리스트 / 나이트룩스 / 디지털수중사진(DUP) / 조류다이빙 /
                AWARE 어류식별 다이빙 / 다중수심 다이빙 / 정밀 부력조절 /
                보트다이빙 / 수중 자연주의자 / 수중스쿠버(DPV)다이빙 /
                드라이슈트 다이빙 / 야간 다이빙 / 수중항법 다이빙 / 수중비디오
                다이빙 / 아이스 다이빙 / 딥다이빙 / 사이드 마운트 다이빙 /
                난파선 다이빙 / 동굴 다이빙 / 수생과 인양 다이빙
              </p>
            </div>
          </div>
        </div>
