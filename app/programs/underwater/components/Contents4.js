    ...
    <div className="w-[80vw] h-full flex flex-col items-center justify-center">
      <div className="w-full h-[400px] md:h-[800px] flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 h-full flex flex-col items-center justify-center gap-y-2 md:gap-y-5">
          <div className="text-lg md:text-2xl">Underwater Dance Instructor</div>
          <div className="text-2xl md:text-5xl font-bold">언더워터 댄스 강사</div>
          <Divider className="w-1/2 h-1 bg-black"></Divider>
          <div className="text-sm md:text-3xl">물속에서 창조되는 독창적 퍼포먼스</div>
        </div>
      </div>
      ...
      >
        ...
        <div className="text-sm md:text-3xl text-center md:text-start">
          <span className="font-bold">※ 어드밴스드 언더워터 댄스 수료자 대상</span>
        </div>
      </div>

      <div className="w-full h-full my-6 md:my-12 flex flex-col items-center justify-evenly gap-y-5 md:gap-y-20">
        <div className="text-2xl md:text-5xl font-bold">언더워터 댄스강사 과정 교육 안내</div>
        <Divider className="w-full h-1 bg-black"></Divider>

        <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-12 gap-y-5 mt-6 md:mt-0 mb-6 md:mb-0">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/3 md:w-1/2 h-12 bg-[#468FAF] rounded-full flex items-center justify-center text-center text-lg md:text-3xl font-bold py-2">
            수업내용
          </div>
        ...
        <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-12 gap-y-5">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/3 md:w-1/2 h-12 bg-[#A9D6E5] rounded-full flex items-center justify-center text-center text-lg md:text-3xl font-bold py-2">
            업그레이드
          </div>
        ...
        <div className="text-sm md:text-3xl flex flex-col justify-evenly items-start gap-x-2 p-5 w-4/5 h-[248px] gap-y-2 px-4 md:px-12 border-2 border-black mt-12">
          <div>
