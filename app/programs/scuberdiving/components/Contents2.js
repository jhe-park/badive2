    ...
    <div className="w-[80vw] h-full flex flex-col items-center justify-center">
      <div className="w-full h-[800px] flex ">
        ...
        <div className="w-1/2 h-full flex flex-col items-center justify-center gap-y-5">
          <div className="text-2xl">Open Water Diver</div>
          <div className="text-5xl font-bold">오픈워터 다이버</div>
          <Divider className="w-1/2 h-1 bg-black"></Divider>
          <div className="text-3xl">낮은 수심 펀다이빙 가능</div>
        </div>
      </div>
      ...
      <div className="w-full h-[600px] my-12 flex flex-col items-center justify-evenly gap-y-5">
        <div className="text-5xl font-bold">오픈워터 다이버 교육 안내</div>
        <Divider className="w-full h-1 bg-black"></Divider>
        <div className="text-5xl">
          이론교육 1회 + 제한수역(다이빙풀) 3회 교육 + 개방수역(바다해양) 교육
        </div>
        <div className="flex  items-center justify-evenly gap-y-5 gap-x-12 w-4/5">
          <div className="flex flex-col items-center justify-start gap-y-5 w-full bg-[#BBD1EA] rounded-lg p-5 h-[300px]">
          ...
          <div className="flex flex-col items-center justify-start gap-y-5 w-full bg-[#A1C6EA] rounded-lg p-5 h-[300px]">
            <div className="text-3xl bg-white rounded-lg p-2 w-full text-center">
              제한수역
            </div>
            <div className="text-3xl w-2/3">
          ...
          <div className="flex flex-col items-center justify-start gap-y-5 w-full bg-[#507DBC] rounded-lg p-5 h-[300px]">
            <div className="text-3xl bg-white rounded-lg p-2 w-full text-center">
              개방수역
            </div>
            <div className="text-3xl w-2/3">
      ...
      <div className="w-full h-[500px] my-12 flex flex-col items-center justify-evenly gap-y-5">
        <div className="text-5xl font-bold">오픈워터 다이버 자격증 발급 </div>
        <Divider className="w-full h-1 bg-black"></Divider>

        <div className="text-3xl flex flex-col justify-center items-center gap-x-2 bg-[#BBD1EA] rounded-lg p-5 w-4/5 h-[200px] gap-y-5 overflow-hidden">
          <div>
