    ...
    <div className="w-[80vw] h-full flex flex-col items-center justify-center">
      <div className="w-full h-full md:h-[800px] flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 h-full flex flex-col items-center justify-center gap-y-2 md:gap-y-5">
          <div className="text-lg md:text-5xl font-bold">스페셜 티</div>
          <Divider className="w-1/2 h-1 bg-black"></Divider>
          <div className="text-sm md:text-3xl">스쿠버 다이빙 스킬업 과정</div>
        </div>
      </div>
      ...
      <div className="w-full h-full my-6 md:my-12 flex flex-col items-center justify-evenly gap-y-5">
        ...
        <div className="w-4/5 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12">
          <div className="col-span-1 flex items-center relative h-24 bg-[#EDF2FB] rounded-lg">
            <div className="absolute left-[5%]">
              <GoShieldCheck className="text-3xl md:text-5xl text-sky-600" />
            </div>
        ...
        <div className="w-4/5 h-full flex items-center justify-center gap-y-5 flex-col text-sm md:text-3xl bg-[#65AFFF] py-6 md:py-12 mt-6 md:mt-12">
          ...
          <div className="text-white flex flex-col items-center justify-evenly gap-y-2 w-[90%]">
            <p className="text-center">
              프로젝트 어웨어 ·산호 암초 보존 · 응급산소 제공자 · 나이트룩스 · 조류 다이빙 · AWARE 어류식별 다이빙
            </p>
            <p className="text-center">
              다중 수심 다이빙 · 정밀 부력조절 · 보트 다이빙 · 수중스쿠터(DPV)다이빙 · 드라이슈트 다이빙
            </p>
            <p className="text-center">
              야간 다이빙 · 수중항법 다이빙 · 수중비디오 다이빙 · 아이스 다이빙 · 사이드 마운트 다이빙 · 난파선 다이빙
            </p>
      ...
      <div className="w-full h-full my-6 md:my-12 flex flex-col items-center justify-evenly gap-y-5">
        <div className="text-2xl md:text-5xl font-bold">스페셜 티 교육 과정</div>
        <Divider className="w-full h-1 bg-black md:my-12"></Divider>
        ...
        <div className="w-full h-full flex flex-col items-center justify-evenly gap-y-8 md:gap-y-14">
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-8 md:py-12 gap-y-5 mt-12">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/3 md:w-1/2 bg-[#EDF2FB] rounded-full flex items-center justify-center text-center text-lg md:text-3xl font-bold py-2">
              01
            </div>

            <div className="text-sm md:text-3xl">■ 딥다이빙</div>
            <div className="text-sm md:text-3xl text-[#8D0000] flex flex-col items-center justify-evenly px-4 md:px-0">
              <p>
                · 최대수심 40m 무감압 오픈워터 다이빙을 계획하고 실수할 수 있도록 훈련하는 과정
              </p>
            </div>
          </div>
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-8 md:py-12 gap-y-5 mt-12">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/3 md:w-1/2 bg-[#E2EAFC] rounded-full flex items-center justify-center text-center text-lg md:text-3xl font-bold py-2">
              02
            </div>

            <div className="text-sm md:text-3xl">■ 디지털 영상(촬영) </div>
            <div className="text-sm md:text-3xl text-[#8D0000] flex flex-col items-center justify-evenly px-4 md:px-0">
              <p>
                · 비디오와 사진을 포함하여 다양한 수중 영상 장비 사용법에 대해 훈련하는 과정
              </p>
            </div>
          </div>
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-8 md:py-12 gap-y-5 mt-12">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/3 md:w-1/2 bg-[#D7E3FC] rounded-full flex items-center justify-center text-center text-lg md:text-3xl font-bold py-2">
              03
            </div>

            <div className="text-sm md:text-3xl">■ 드라이슈트 다이버 과정 </div>
            <div className="text-sm md:text-3xl text-[#8D0000] flex flex-col items-center justify-evenly px-4 md:px-0">
              <p>
                · 드라이 슈트 착용법 · 드라이슈트 납무게 산출 및 수면에서의 부력 점검 · 직립 또는 수평자세로 하강 및 상승
              </p>
              <p>
                · 수중에서 인플레이터 호스 분리 및 다시 연결하기 · 드라이슈트 배출밸브 오픈 후 중성부력 유지하기
              </p>
              <p>· 드라이슈트 침수 대처 등 응급사항 훈련 </p>
            </div>
          </div>
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-8 md:py-12 gap-y-5 mt-12">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/3 md:w-1/2 bg-[#CCDBFD] rounded-full flex items-center justify-center text-center text-lg md:text-3xl font-bold py-2">
              04
            </div>

            <div className="text-sm md:text-3xl">■ 장비전문가 과정 </div>
            <div className="text-sm md:text-3xl text-[#8D0000] flex flex-col items-center justify-evenly px-4 md:px-0">
              <p>
                · 올바른 다이빙 장비 관리 요령과 스쿠버 시스템의 작동 방법에 대해 훈련하는 과정
              </p>
            </div>
          </div>
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-8 md:py-12 gap-y-5 mt-12">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/3 md:w-1/2 bg-[#C1D3FE] rounded-full flex items-center justify-center text-center text-lg md:text-3xl font-bold py-2">
              05
            </div>

            <div className="text-sm md:text-3xl">■ 수중 자연주의자 과정 </div>
            <div className="text-sm md:text-3xl text-[#8D0000] flex flex-col items-center justify-evenly px-4 md:px-0">
              <p>
                · 다이버들이 과학적인 방법을 사용하여 자료 수집과 훈련 장소의 동물 및 식물들을 인식하는 방법을 훈련하는 과정
              </p>
            </div>
          </div>
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-8 md:py-12 gap-y-5 mt-12">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/3 md:w-1/2 bg-[#B6CCFE] rounded-full flex items-center justify-center text-center text-lg md:text-3xl font-bold py-2">
              06
            </div>

            <div className="text-sm md:text-3xl">■ 야간 다이빙 과정 </div>
            <div className="text-sm md:text-3xl text-[#8D0000] flex flex-col items-center justify-evenly px-4 md:px-0">
              <p>
                · 일몰 후부터 일출 전까지의 사이에 실시된 다이빙을 의미하며, 야간 다이빙 준비를 위한 상세 다이빙 계획 수립,
              </p>
          ...
          <div className="w-4/5 flex flex-col items-center justify-evenly border-2 border-black relative py-8 md:py-12 gap-y-5">
            ...
            <div className="text-sm md:text-3xl flex flex-col items-center justify-evenly w-[95%] px-4 md:px-0">
              <p>
                프로젝트 어웨어 / 산호암초 보존 / 응급산소 제공자 / 나이트룩스 / 조류다이빙 / AWARE 어류식별 다이빙 / 다중수심 다이빙 / 정밀 부력조절 / 보트다이빙 / 수중스쿠터(DPV)다이빙 / 드라이슈트 다이빙 / 야간 다이빙 / 수중항법 다이빙 / 수중비디오 다이빙 / 아이스 다이빙 / 사이드 마운트 다이빙 / 난파선 다이빙 / 동굴 다이빙 / 수생과 인양 다이빙
              </p>
            </div>
          </div>
        </div>
