    ...
    <div className="w-[80vw] h-full flex flex-col items-center justify-center">
      <div className="w-full h-[800px] flex ">
        ...
        <div className="w-1/2 h-full flex flex-col items-center justify-center gap-y-5">
          <div className="text-2xl">Advanced Freediving</div>
          <div className="text-[64px] font-bold">어드밴스 프리다이버</div>
          <Divider className="w-1/2 h-1 bg-black"></Divider>
          <div className="text-3xl">한계를 뛰어넘는 어드밴스드 프리다이버</div>
        </div>
      </div>
      ...
      <div className="w-full h-full my-12 flex flex-col items-center justify-evenly gap-y-5">
        <div className="text-5xl font-bold">어드밴스 프리다이버 교육 안내</div>
        <Divider className="w-full h-1 bg-black my-12"></Divider>
        <div className="text-5xl">
          이론교육 1회 + 제한수역(1회) + 해양교육(2회)
        </div>
        <div className="flex  items-center justify-evenly gap-y-5 gap-x-12 w-4/5 h-full my-12">
          <div className="flex flex-col items-center justify-start gap-y-5 w-full bg-[#BBD1EA] rounded-lg p-5 h-[450px] overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-start gap-y-5 w-full bg-[#A1C6EA] rounded-lg p-5 h-[450px] overflow-hidden">
            <div className="text-3xl bg-white rounded-lg p-2 w-full text-center">
              제한수역 실습
            </div>
            <div className="text-3xl w-2/3">
          ...
          <div className="flex flex-col items-center justify-start gap-y-5 w-full bg-[#507DBC] rounded-lg p-5 h-[450px] overflow-hidden">
            <div className="text-3xl bg-white rounded-lg p-2 w-full text-center">
              해양교육
            </div>
            <div className="text-3xl w-2/3">
      ...
      <div className="w-full h-full my-12 flex flex-col items-center justify-evenly gap-y-20">
        <div className="text-5xl font-bold">어드밴스드 프리다이버 교육 과정</div>
