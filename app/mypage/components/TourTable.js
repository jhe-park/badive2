    ...
    const fetchTourData = async () => {
      ...
      if (searchValue) {
        if (searchFilter === "제목") {
          query = query
            .not("tour_id", "is", null)
            .ilike("tour_id.title", `%${searchValue}%`);
        } else if (searchFilter === "장소") {
          query = query
            .not("tour_id", "is", null)
            .ilike("tour_id.region", `%${searchValue}%`);
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell className="text-center flex justify-center items-center">
                        <div className="w-12 h-12 md:w-24 md:h-24 relative">
                          <Image
                            alt="program"
                            src={item?.tour_id?.image || "/noimage/noimage.jpg"}
                            fill
                          ></Image>
                        </div>
                      </TableCell>
              ...
              <ModalBody>
                <div className="flex flex-col items-center gap-y-4">
                  <div className="w-96 h-96 relative">
                    <Image
                      src={
                        selectedTour?.tour_id?.image || "/noimage/noimage.jpg"
                      }
                      alt="program"
                      fill
                    />
                  ...
                  <div className="w-full space-y-2">
                    ...
                    <div className="flex justify-start items-center gap-x-2 w-full">
                      ...
                      <span>
                        ...
                        최대 {selectedTour?.tour_id?.max_participants}명
